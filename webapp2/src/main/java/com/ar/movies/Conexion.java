...
public class Conexion {
    ...
    public Conexion() {
        ...
        try {
            ...
            // Paso 2: Establecer la conexión con la base de datos 'peliculas_java' en localhost
            this.connection = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/peliculas_java",  // URL de conexión JDBC para MySQL
